...
<script src="{{ asset('vendors/js-cookie/src/js.cookie.js') }}"></script>
<!--<script src="{{ asset('vendors/moment/min/moment.min.js') }}"></script>-->
<script src="{{ asset('vendors/tooltip.js/dist/umd/tooltip.min.js') }}"></script>
<script src="{{ asset('vendors/perfect-scrollbar/dist/perfect-scrollbar.js') }}"></script>
<script src="{{ asset('vendors/wnumb/wNumb.js') }}"></script>
...
<script
    src="{{ asset('vendors/vendors/bootstrap-multiselectsplitter/bootstrap-multiselectsplitter.min.js') }}"></script>
...
<script src="{{ asset('vendors/js/framework/components/plugins/forms/jquery-validation.init.js') }}"></script>
...
<!--<script src="{{ asset('assets/demo/default/custom/crud/datatables/basic/headers.js') }}"></script>-->
<script src="{{ asset('assets/demo/default/custom/crud/forms/widgets/bootstrap-select.js') }}"></script>
<!--<script src="{{ asset('assets/demo/default/custom/components/base/sweetalert2.js') }}" type="text/javascript"></script>-->
<!--<script src="{{ asset('assets/demo/default/custom/crud/datatables/basic/paginations.js') }}"></script>-->
<!--<script src="./assets/demo/default/custom/crud/datatables/extensions-options/buttons.js" type="text/javascript"></script>-->
...
<script src="{{ asset('assets/demo/default/custom/components/maps/google-maps.js') }}"></script>-->
<!--end::Page Scripts -->
<script src="{{ asset('assets/js/jquery.tableTotal.js') }}"></script>
...
{{--
<script src="{{ asset('theme/html/demo1/dist/assets/plugins/global/plugins.bundledf5a.js?v=7.2.6') }}"></script>
<script src="{{ asset('theme/html/demo1/dist/assets/plugins/custom/prismjs/prismjs.bundledf5a.js?v=7.2.6') }}"></script>
--}}
<script src="{{ asset('theme/html/demo1/dist/assets/js/scripts.bundledf5a.js?v=7.2.6') }}"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Vendors(used by this page)-->
{{--
<script src="{{ asset('theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundledf5a.js?v=7.2.6') }}"></script>
--}}
{{--<script src="http://maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM"></script>
<script src="{{ asset('theme/html/demo1/dist/assets/plugins/custom/gmaps/gmapsdf5a.js?v=7.2.6') }}"></script>--}}
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
{{--<script src="{{ asset('theme/html/demo1/dist/assets/js/pages/widgetsdf5a.js?v=7.2.6') }}"></script>--}}
<!--end::Page Scripts-->
